-- Final fix for admin_update_cv function with exactly 17 parameters
-- This matches the exact parameters being sent from Form.js
...
-- Create the function with exactly 17 parameters
