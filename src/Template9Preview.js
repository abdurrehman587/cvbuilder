...
import Template9PDF from './Template9PDF';
...
const Template9Preview = ({ formData, formHeight }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Template9PDF formData={formData} visibleSections={visibleSections} />
      </article>
    </div>
  );
};

export default Template9Preview;
