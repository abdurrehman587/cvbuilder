...
const Template1PDF = ({ formData, visibleSections = [] }) => {
  ...
  const renderSkills = (skills) => (
    <div style={skillsContainerStyle} className="responsive-skill-container">
  ...
  const renderOtherInformation = (otherInfo) => {
    ...
    return (
      <section style={sectionStyle} className="responsive-section" aria-label="Other Information Section">
...
<>
  <style>{`
    @media (max-width: 600px) {
      ...
      .responsive-skill-container {
        grid-template-columns: 1fr !important;
      }
    }
  `}</style>

<article ref={containerRef} style={containerStyle} className="responsive-container">
      <header style={headerStyle} className="responsive-header">
        {formData.image ? (
          <img
            src={URL.createObjectURL(formData.image)}
            alt="Profile"
            style={photoStyle} className="responsive-photo"
          />
        ) : (
          <div style={noPhotoPlaceholderStyle}>No Photo</div>
        )}
        <div style={personalInfoStyle} className="responsive-personal-info">
      ...
      {visibleSections.includes('objective') && formData.objective && (
        <section style={sectionStyle} className="responsive-section" aria-label="Objective Section">
      ...
      {visibleSections.includes('education') && formData.education?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Education Section">
      ...
      {visibleSections.includes('workExperience') && formData.workExperience?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Work Experience Section">
      ...
      {visibleSections.includes('skills') && formData.skills?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Skills Section">
      ...
      {visibleSections.includes('certifications') && formData.certifications?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Certifications Section">
      ...
      {visibleSections.includes('projects') && formData.projects?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Projects Section">
      ...
      {visibleSections.includes('languages') && combinedLanguages.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Languages Section">
      ...
      {visibleSections.includes('hobbies') && formData.hobbies?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="Hobbies Section">
      ...
      {visibleSections.includes('references') && formData.references?.length > 0 && (
        <section style={sectionStyle} className="responsive-section" aria-label="References Section">
