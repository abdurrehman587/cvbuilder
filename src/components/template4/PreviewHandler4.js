...
const usePreviewHandler = (passedFormData = null) => {
  ...
  // Function to get form data from Form4 inputs
  ...
  useEffect(() => {
    ...
    if (storedData && (!passedFormData || !passedFormData.name)) {
      try {
        ...
        console.log('PreviewHandler4 - Loaded form data from localStorage:', parsedData);
        dataToUse = parsedData;
      } catch (e) {
        console.error('PreviewHandler4 - Error parsing stored form data:', e);
      }
    }
    ...
    if (dataToUse) {
      ...
      console.log('PreviewHandler4 - passedFormData:', passedFormData);
      console.log('PreviewHandler4 - dataToUse:', dataToUse);
      console.log('PreviewHandler4 - domData:', domData);
      ...
      console.log('PreviewHandler4 - mergedData:', mergedData);
      console.log('PreviewHandler4 - mergedData.education:', mergedData.education);
      console.log('PreviewHandler4 - mergedData.experience:', mergedData.experience);
