...
import Template10PDF from './Template10PDF';
...
const Template10Preview = ({ formData, formHeight }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Template10PDF formData={formData} visibleSections={visibleSections} />
      </article>
    </div>
  );
};

export default Template10Preview;
